...
namespace ConfigurationManager
{
    internal class SettingFieldDrawer
    {
        ...
        public static void DrawCategoryHeader(string text)
        {
            ...
            {
                _categoryHeaderSkin = GUI.skin.label.Instantiate();
        ...
        public static bool DrawPluginHeader(GUIContent content, bool isCollapsed)
        {
            ...
            {
                _pluginHeaderSkin = GUI.skin.label.Instantiate();
        ...
        private static void DrawColor(SettingEntryBase obj)
        {
            ...
            setting.r = GUILayout.HorizontalSlider(setting.r, 0, 1, GUILayout.ExpandWidth(true));
            GUILayout.Label("G", GUILayout.ExpandWidth(false));
            setting.g = GUILayout.HorizontalSlider(setting.g, 0, 1, GUILayout.ExpandWidth(true));
            GUILayout.Label("B", GUILayout.ExpandWidth(false));
            setting.b = GUILayout.HorizontalSlider(setting.b, 0, 1, GUILayout.ExpandWidth(true));
            GUILayout.Label("A", GUILayout.ExpandWidth(false));
            setting.a = GUILayout.HorizontalSlider(setting.a, 0, 1, GUILayout.ExpandWidth(true));
