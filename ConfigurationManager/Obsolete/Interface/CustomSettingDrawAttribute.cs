...
namespace BepInEx
{
    [Obsolete("Use EditorAttribute on a method instead to create a custom setting entry")]
    public class CustomSettingDrawAttribute : AcceptableValueBaseAttribute
    {
        ...
        public CustomSettingDrawAttribute(string customFieldDrawMethod) => CustomFieldDrawMethod = customFieldDrawMethod;
